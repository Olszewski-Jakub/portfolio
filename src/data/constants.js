export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/14_XtOuThGjRUVJhCTL9SKtceTA0AFNGX/view?usp=sharing",
...
export const experiences = [
  {
    ...
    desc: "Successfully conceived and developed an independent project (Kalkulator Receptury) within the company, implementing it to enhance overall operations. Implemented automated processes to streamline development workflow and reduce manual labor.",
    skills: [
      "Kotlin",
      "Azure AAD",
      "Hilt",
